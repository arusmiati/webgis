...
function PointMarker(props) {
   ...
   // const res1 = data?.cluster1_result
    ...
    // console.log(data)
    return Object.keys(coord6)?.map((kec) => {
                ...
                <div className="ml-2 grid grid-cols-1 gap-4 md:grid-cols-3 sm:grid-cols-2 xs:grid-cols-1">
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[0])}>
                        <div className="col-span-1" style={{
                         ...
                         <div className="col-span-9" style={{ color: 'white'}}>Jumlah Tifoid peringkat kedua dengan rentang umur 9 – 24 tahun dimana nafsu makan  kurang, sering jajan diluar, dan sering memakai jamban/toilet
                         </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[1])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white'}}>Jumlah Tifoid peringkat keempat (jumlah kasus Tifoid terendah) karena tidak terjadi kasus Tifoid dimana nafsu makan normal, jarang jajan diluar, dan jarang memakai jamban/toilet
                         </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[2])}>
                        <div className="col-span-1" style={{
                         ...
                         <div className="col-span-9" style={{ color: 'white'}}>Jumlah Tifoid peringkat pertama (jumlah kasus Tifoid tertinggi) dengan rentang umur 18 – 24 tahun dimana nafsu makan sangat kurang, sering jajan diluar, dan sering memakai jamban/toilet
                         </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[3])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white'}}>Jumlah Tifoid peringkat ketiga dengan rentang umur 3 – 42 tahun dimana nafsu makan normal, jarang jajan diluar, dan jarang memakai jamban/toilet
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[5])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white' }}>Jumlah Tifoid peringkat keempat (jumlah kasus Tifoid terendah) karena tidak terjadi kasus Tifoid dimana nafsu makan normal, tidak jajan diluar, dan jarang memakai jamban/toilet
                        </div>
                    </div>
