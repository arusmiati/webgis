...
function PointMarker(props) {
    ...
    // console.log(data)
    return Object.keys(coord4)?.map((kec) => {
                ...
                <div className="ml-2 grid grid-cols-1 gap-4 md:grid-cols-3 sm:grid-cols-2 xs:grid-cols-1">
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[0])}>
                        <div className="col-span-1" style={{
                         ...
                         <div className="col-span-9" style={{ color: 'white'}}>Jumlah TB peringkat keempat dengan rentang umur 55 – 58 tahun dimana nafsu makan normal, tidak sering jajan diluar, dan jarang memakai jamban/toilet
                         </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[1])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white'}}>Jumlah TB peringkat pertama (jumlah kasus TB tertinggi) dengan rentang umur 40 – 46 tahun dimana nafsu makan sangat kurang,  sering jajan diluar dan sering memakai jamban/toilet
                        </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[2])}>
                        <div className="col-span-1" style={{
                         ...
                         <div className="col-span-9" style={{ color: 'white'}}>Jumlah TB peringkat keempat dengan rentang umur 38 tahun dimana nafsu makan normal, jarang jajan diluar, dan jarang memakai jamban/toilet
                         </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[3])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white'}}>Jumlah TB peringkat keempat dengan rentang umur 33 – 48 tahun dimana nafsu makan normal, jarang jajan diluar, dan jarang memakai jamban/toilet
                        </div>
                        </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[4])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white' }}>Jumlah TB peringkat kelima (jumlah kasus TB terendah) karena tidak terjadi kasus TB dimana nafsu makan normal, tidak sering jajan diluar dan jarang memakai jamban/toilet
                        </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[5])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white' }}>Jumlah TB peringkat kelima (jumlah kasus TB terendah) karena tidak terjadi kasus TB dimana nafsu makan normal, jarang jajan diluar dan jarang memakai jamban/toilet
                        </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[6])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white' }}>Jumlah TB peringkat ketiga dengan rentang umur 18 – 48 tahun dimana nafsu makan normal, jarang jajan diluar, dan jarang memakai jamban/toilet
                        </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[7])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white' }}>Jumlah TB peringkat kedua dengan rentang umur 31 – 64 tahun dimana nafsu makan kurang,, sering jajan diluar, dan sering memakai jamban/toilet
                        </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[8])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white' }}>Jumlah TB peringkat keempat dengan rentang umur 42 tahun dimana nafsu makan normal, tidak sering jajan diluar, dan jarang memakai jamban/toilet
                        </div>
                    </div>
