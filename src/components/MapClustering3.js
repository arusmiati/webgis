...
function PointMarker(props) {
    ...
    // console.log(data)
    return Object.keys(coord3)?.map((kec) => {
        ...
        if (!selectedData || (selectedData && selectedData == kec.split(' (')[0])) {
            ...
            //         '\nSampah = ' + res1['First']['(\'Ada sampah tapi tidak banyak\', \'mean\')'] +
                ...
                <div className="ml-2 grid grid-cols-1 gap-4 md:grid-cols-3 sm:grid-cols-2 xs:grid-cols-1">
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[0])}>
                        <div className="col-span-1" style={{
                         ...
                         <div className="col-span-9" style={{ color: 'white'}}>Jumlah Tifoid peringkat keenam (jumlah kasus Tifoid terendah) karena tidak terjadi kasus Tifoid dimana ketersediaan air bersih masih sangat sedikit, sampah tidak banyak, dan sistem ventilasi ada disemua ruangan
                         </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[1])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white'}}>Jumlah Tifoid peringkat kelima dengan rentang umur 10 – 42 tahun dimana ketersediaan air bersih masih sangat sedikit, sampah tidak banyak dan jarang dibersihkan, dan sistem ventilasi ada disemua ruangan
                        </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[2])}>
                        <div className="col-span-1" style={{
                         ...
                         <div className="col-span-9" style={{ color: 'white'}}>Jumlah Tifoid peringkat kedua dengan rentang umur 18 tahun dimana ketersediaan air bersih sudah baik, sampah tidak banyak, dan sistem ventilasi ada disemua ruangan
                         </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[3])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white'}}>Jumlah Tifoid peringkat pertama (jumlah kasus Tifoid tertinggi) dengan rentang umur 19 – 24 tahun dimana ketersediaan air bersih sudah baik, sampah tidak banyak tapi jarang dibersihkan, dan sistem ventilasi ada disemua ruangan
                        </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[4])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white' }}>Jumlah Tifoid peringkat keenam (jumlah kasus Tifoid terendah) karena tidak terjadi kasus Tifoid dimana ketersediaan air bersih masih sangat sedikit, pembuangan sampah bersih, dan sistem ventilasi ada disemua ruangan
                        </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[5])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white' }}>Jumlah Tifoid peringkat kedua dengan rentang umur 0 – 23 tahun dimana ketersediaan air bersih sudah baik, sampah jarang dibersihkan, dan sistem ventilasi ada disemua ruangan
                        </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[6])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white' }}>Jumlah Tifoid peringkat keenam (jumlah kasus Tifoid terendah) karena tidak terjadi kasus Tifoid dimana ketersediaan air bersih masih sangat sedikit, sampah dikelilingi lalat/nyamuk, dan sistem ventilasi hanya sedikit
                        </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[7])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white' }}>Jumlah Tifoid peringkat keenam (jumlah kasus Tifoid terendah) karena tidak terjadi kasus Tifoid dimana ketersediaan air bersih masih sangat sedikit, sampah tidak banyak, dan sistem ventilasi jarang terbuka
                        </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[8])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white' }}>Jumlah Tifoid peringkat ketiga dengan rentang umur 9 – 24 tahun dimana ketersediaan air bersih sudah baik, sampah jarang dibersihkan, dan sistem ventilasi ada disemua ruangan
                        </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[9])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white' }}>Jumlah Tifoid peringkat keenam (jumlah kasus Tifoid terendah) karena tidak terjadi kasus Tifoid dimana ketersediaan air bersih masih sangat sedikit, pembuangan sampah bersih, dan sistem ventilasi jarang terbuka
                        </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[10])}>
                        <div className="col-span-1" style={{
                            color: '#9D5C0D',
                            backgroundColor: warna[10],
                            padding: 5,
                            borderRadius: 50,
                            width: '25px',
                            height: '25px'
                        ...
                        <div className="col-span-9" style={{ color: 'white' }}>Jumlah Tifoid peringkat keempat dengan rentang umur 3 – 20 tahun dimana ketersediaan air bersih masih sedikit, pembuangan sampah bersih, dan sistem ventilasi ada disemua ruangan
                        </div>
                    </div>
                    {/* <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[8])}>
                        <div className="col-span-1" style={{
