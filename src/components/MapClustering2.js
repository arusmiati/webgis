...
function PointMarker(props) {
    ...
    // console.log(data)
    return Object.keys(coord2)?.map((kec) => {
                ...
                <div className="ml-2 grid grid-cols-1 gap-4 md:grid-cols-3 sm:grid-cols-2 xs:grid-cols-1">
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[0])}>
                        <div className="col-span-1" style={{
                         ...
                         <div className="col-span-9" style={{ color: 'white'}}>Jumlah DBD peringkat kelima (jumlah kasus DBD terendah) karena tidak terjadi kasus DBD dimana ketersediaan air bersih masih sangat sedikit, pembuangan sampah bersih, dan ventilasi jarang terbuka.
                         </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[1])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white'}}>Jumlah DBD peringkat kelima (jumlah kasus DBD terendah) karena tidak terjadi kasus DBD dimana ketersediaan air bersih masih sangat sedikit, pembuangan sampah bersih, dan ventilasi hanya sedikit.
                        </div> </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[2])}>
                        <div className="col-span-1" style={{
                         ...
                         <div className="col-span-9" style={{ color: 'white'}}>Jumlah DBD peringkat kedua dengan rentang umur 8 – 19 tahun dimana ketersediaan air bersih masih sudah baik, sampah jarang dibersihkan, dan sistem ventilasi ada di semua ruangan.
                         </div></div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[3])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white'}}>Jumlah DBD peringkat kelima (jumlah kasus DBD terendah) karena tidak terjadi kasus DBD dimana ketersediaan air bersih masih sangat sedikit, sampah tidak banyak, dan sistem ventilasi ada di semua ruangan.
                        </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[4])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white' }}>Jumlah DBD peringkat pertama (Jumlah kasus DBD tertinggi) dengan rentang umur 0 – 19 tahun dimana ketersediaan air bersih masih sudah baik, sampah jarang dibersihkan, dan sistem ventilasi ada di semua ruangan.
                        </div>
                    </div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[5])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white' }}>Jumlah DBD peringkat kelima (jumlah kasus DBD terendah) karena tidak terjadi kasus DBD dimana ketersediaan air bersih masih sangat sedikit, sampah tidak banyak, dan sistem ventilasi jarang terbuka
                        </div></div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[6])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white' }}>Jumlah DBD peringkat ketiga dengan rentang umur 16 – 31 tahun dimana ketersediaan air bersih masih sedikit, sampah jarang dibersihkan, dan sistem ventilasi ada di semua ruangan.
                        </div></div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[7])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white' }}>Jumlah DBD peringkat kelima (jumlah kasus DBD terendah) karena tidak terjadi kasus DBD dimana ketersediaan air bersih masih sangat sedikit, sampah jarang dibersihkan, dan sistem ventilasi ada di semua ruangan
                        </div></div>
                    <div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[8])}>
                        ...
                        <div className="col-span-9" style={{ color: 'white' }}>Jumlah DBD peringkat keempat dengan rentang umur 18 – 22 tahun dimana ketersediaan air bersih masih sangat sedikit, pembuangan sampah bersih, dan sistem ventilasi hanya sedikit
                        </div></div>
                    {/*<div className="grid grid-cols-10 gap-1" onClick={() => onClickColor(warna[6])}>
                        <div className="col-span-1" style={{
                            color: '#063b00',
