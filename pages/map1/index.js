...
function Cluster() {
    ...
    const Map = dynamic(
        () => import('../../src/components/MapClustering1'), // replace '@components/map' with your component's location
        ...
        <div className="grid grid-cols-5 gap-4">
                ...
                {data && (
                    <div style={{height: '93vh', overflowY: 'auto',}}>
                        ...
                        <h2 className="ml-2 mt-1" style={{fontWeight: "bold", fontSize: 20}}> List Address</h2>
                        {generateKec()}
                    </div>
                )}
