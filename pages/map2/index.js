...
function Cluster() {
    ...
    const Map = dynamic(
        () => import('../../src/components/MapClustering2'), // replace '@components/map' with your component's location
                ...
                {data && (
                    <div style={{height: '93vh', overflowY: 'auto',}}>
                        <div className="flex items-center justify-center">
                            <Button className="btn-kec ml-2 mr-2 bg-blue-500 hover:bg-blue-700 text-sm text-white font-semibold py-2 px-3 rounded mt-5 mb-2"
                                onClick={() => setSelectedData('')}>
                                Tampilkan semua alamat
                            </Button>
                        </div>
                        <h2 className="ml-2 mt-1" style={{fontWeight: "bold", fontSize: 20}}> Daftar Alamat</h2>
                        {generateKec()}
                    </div>
                )}
