        ...
        <div>
                    ...
                    <div className="inputdata max-w-7xl p-2 shadow-xl rounded-lg bg-white">
                        ...
                        >
                            <div className="input-item">
                                ...
                                <div className="btn m-2 place-content-center">
                                    <button
                                        type="submit"
            ...
            <div className="flex flex-col items-center">
                    ...
                    <div className="grid justify-items-center p-3 lg:p-5 flex flex-col md:flex-row w-full">
                        <div
                            className="data bg-white rounded-md shadow-lg max-w-full dasboardTable overflow-x-auto overflow-y-hidden">
                            <div className="text-center justify-items-center items w-full font-semibold mt-3 mb-2" style={{fontSize: "20px"}}>
                                 INFECTIOUS DISEASES PATIENT DATASET
                            </div>
                        <div className="btn m-2">
                            <button
                                type="button"
                                onClick={handleCluster}
                                className="btn-cluster text-white font-bold py-2 px-4 my-1 rounded"
                            >
                                Generate Cluster
                            </button>
                            {loading && <p>Please Wait...</p>}
